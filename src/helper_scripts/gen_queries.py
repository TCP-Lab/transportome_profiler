...
TEMPLATE = {
    "case": ["<meta>@sample?_study=TCGA&_primary_site=<site>&_sample_type!=[Solid Tissue Normal,Control Analyte]"],
    "control": ["<meta>@sample?_study=[TCGA,GTEX]&_primary_site=<site>&_sample_type=[Normal Tissue,Solid Tissue Normal]&_sample_type!=Cell Line"]
}
...
if __name__ == "__main__":
    ...
    parser.add_argument("matches_file", type=Path, help="Path to the input matches file")
